...
&emsp;Start: [UserInput] [Extender]&emsp;&emsp;&emsp;&emsp;&emsp;// Format of the initial block<br/>
&emsp;&emsp;int* [UserInput] [Extender]&emsp;&emsp;&emsp;&emsp;&emsp;// The user places an [int* [UserInput]] terminal block into [UserInput]<br/>
...
&emsp;&emsp;int* variable = &var2;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;// The user ends the statement using the end_statement block.<br/>
